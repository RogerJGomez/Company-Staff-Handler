...
include ('../config/conex.php');//Se conecta con la BD  
  ...
  $query = "DELETE FROM clientes WHERE codigo='$codigo'"; //Se ejecuta la consulta donde se elimina una fila especifa donde codigo sea igual a la variable codigo que se recibió del ajax
