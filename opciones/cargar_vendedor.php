...
$query3 = "SELECT DISTINCT trim(codigo) as codigo, trim(nombre) as nombre FROM vendedor";//Se ejecuta la consulta en la que seleccionan el nombre y el codigo sin repetirse
